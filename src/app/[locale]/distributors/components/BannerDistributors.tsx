...
const BannerDistributors = () => {
  ...
  return (
    <div className="w-full  bg-gradient-to-r from-[#00372B] via-black to-[#022530] flex justify-center items-center py-10 md:py-16 px-4">
      <div
        className="p-6 md:p-10 rounded-3xl w-full max-w-[1200px] h-[550px] flex-col gap-y-4 flex justify-center items-center"
        style={{
      ...
      >
        ...
        <p className="text-[#FFFFFF] text-center w-10/12 md:w-8/12">
