...
import Navigation from "../../../../shared/components/HeaderComponents/Navigation";
import MegaMenu from "../../../../shared/components/HeaderComponents/MegaMenu";
import MobileMenu from "../../../../shared/components/HeaderComponents/MobileMenu";
import LanguageDropdown from "../../../../shared/components/HeaderComponents/LanguageSelector";
import EncryptedLogo from "../../../../shared/components/HeaderComponents/EncryptedLogo";
...
export default function Header() {
  ...
  return (
    <header className="relative z-50" ref={headerRef}>
      <div className="bg-[#151515F2] border-b border-[#1A1A1A]">
        {" "}
          ...
          <nav className="flex items-center justify-between">
              ...
              <form className="max-w-md mx-auto">
                <div className="relative">
                  <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                    <svg
                      className="w-4 h-4 ml-1 text-[#B4B4B4] dark:text-gray-400"
                      aria-hidden="true"
                  ...
                  <input
                    type="search"
                    id="default-search"
                    className="block w-full h-[50px] px-4 ps-10 font-normal text-sm text-[#B4B4B4] border border-[#484848] rounded-full bg-[#131313] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div className="hidden lg:flex items-center gap-0">
              ...
              {/* <Link
                href="/"
                prefetch
                className="px-4 py-2 text-white hover:bg-[#054d6121] rounded-full transition-colors text-base font-semibold"
              >
                {t("menu.store.label")}
                <span className="ml-2 px-2 py-0.5 text-xs bg-[#06546C] text-[#44D3FF] rounded-full font-normal">
                  {t("menu.store.new")}
                </span>
              </Link> */}
              ...
              <Link
                href="/deliveries"
                prefetch
                className="px-4 py-2 text-base font-semibold text-white hover:bg-[#054d6121] rounded-full transition-colors text-opacity-70"
              >
              ...
              <Navigation
                ...
                buttonClassName="px-4 py-2 text-opacity-70"
              />
              ...
              <Link
                href="/login"
                prefetch
                className="px-4 xl:ml-8 h-[42px] text-sm font-medium text-[#001D26] bg-[#E3F8FF] hover:bg-gray-100 rounded-xl transition-colors flex items-center gap-2"
              >
                <ProfileSvg color="#1C1B1F" />
                {t("menu.login")}
              </Link>
            </div>
          </nav>
