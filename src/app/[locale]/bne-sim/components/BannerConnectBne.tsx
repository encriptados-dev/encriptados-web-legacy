      ...
      <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row items-center justify-between max-w-[1100px]">
        <div className="text-white max-w-xl mb-8 lg:mb-0 z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Conéctate en cualquier <br />
            lugar del mundo con <br />
            <span className="text-[#10b4e7]">total anonimato</span>
          </h2>
          <p className="text-2xl mb-6">
            Tus datos no expiran sin importar el tiempo <br />
            que tardes en consumirlos
          </p>
        </div>
